...
const nodeHalf: UserConfig = {
  entry: ["src/index.ts", "src/client/index.tsx", "src/remote.ts", "src/typert.host.ts", "src/web/host.ts", "src/store.ts", "src/inbox.ts", "src/fleet-channel.ts"],
  format: 'esm',
  dts: true,
  outDir: 'lib',
...
const browserFace: UserConfig = {
  name: '@morewax/dsh-mesh-chat/client',
  ...
  outputOptions: {
    ...
    banner: `window.__ModuleLoader__.load({ id: "@morewax/dsh-mesh-chat", factory: (require) => {`,
    footer: 'return module.exports; } });',
    intro: 'var module = { exports: {} }; var exports = module.exports;',
  },
}

export default defineConfig([nodeHalf, browserFace])
