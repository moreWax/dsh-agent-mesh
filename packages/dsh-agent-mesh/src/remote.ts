...
const serveStatusSchema = z.object({ configured: z.boolean(), target: z.string(), port: z.number(), announceName: z.string(), modelAllowlist: z.array(z.string()), running: z.boolean(), models: z.array(z.string()), backends: z.array(z.object({ name: z.string(), url: z.string(), present: z.boolean() })) })
const serveConfigureRequest = z.object({ enabled: z.boolean(), target: z.string().optional(), announceName: z.string().optional(), modelAllowlist: z.array(z.string()).optional() })
