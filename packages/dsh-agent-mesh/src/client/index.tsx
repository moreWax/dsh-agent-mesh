...
function JoinFleetSection({api,onJoined}:{api:MeshWebApi;onJoined?:(fleet:string)=>void}) {
 const [result,setResult]=useState<{fleets:{name:string;providers:number;peerIds:string[]}[];node:{running:boolean;enrolled:boolean;enrolledHub:string|null};needsReenroll:boolean;membership:{state:"valid"|"stale"|"unpaired";detail?:string}}>()
